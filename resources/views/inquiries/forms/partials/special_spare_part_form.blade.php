<x-inquiry-form-wrapper
    formType="special_spare_part"
    formTitle="فرم درخواست قطعه یدکی خاص"
    formAction="{{ route('inquiries.special_spare_part.store') }}"
>
    <form id="spare-part-form" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <x-input-label for="part_name" value="نام قطعه" />
    ...
    <script>
        ...
        document.getElementById('spare-part-form').addEventListener('submit', function(e) {
            e.preventDefault();
