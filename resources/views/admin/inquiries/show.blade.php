        ...
        <div class="mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm rounded-lg p-6 mt-2">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($inquiry->logs as $log)
                                <tr>
                                    <td class="px-4 py-2 text-sm text-gray-900">{{ $log->created_at->format('Y/m/d H:i') }}</td>
                ...
                <div class="flex justify-end mt-6">
                    <a href="{{ route('admin.inquiries.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-6 rounded">بازگشت به لیست</a>
                </div>
            </div>
        </div>
    </div>
