<x-admin-layout>
    <x-slot name="header">
        لیست استعلام‌های قطعه یدکی خاص
    </x-slot>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">نام قطعه</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($inquiries as $inquiry)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $inquiry->part_name }}</td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2 space-x-reverse">
                                                <a href="{{ route('inquiries.special_spare_parts.show', $inquiry) }}" class="text-blue-600 hover:text-blue-900" title="مشاهده"><i class="fas fa-eye"></i></a>
                                                <a href="{{ route('inquiries.special_spare_parts.show', $inquiry) }}#change-status" class="text-yellow-600 hover:text-yellow-900" title="تغییر وضعیت"><i class="fas fa-exchange-alt"></i></a>
                                                <a href="{{ route('inquiries.special_spare_parts.show', $inquiry) }}#logs" class="text-green-600 hover:text-green-900" title="پیگیری"><i class="fas fa-tasks"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="10" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">هیچ فرم ثبت شده‌ای یافت نشد.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
