            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h2 class="text-xl font-semibold text-gray-900">افزودن آیتم منو جدید</h2>
                    ...
                    <!-- Form -->
                    <form action="{{ route('admin.menu-items.store', $menu) }}" method="POST" class="space-y-6">
                        @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="target" id="target" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        ...
                                        <option value="_parent" {{ old('target') == '_parent' ? 'selected' : '' }}>صفحه والد</option>
                                        <option value="_top" {{ old('target') == '_top' ? 'selected' : '' }}>بالاترین صفحه</option>
                                    </select>
                                    @error('target')
                                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                    @enderror
